...
# create model
model = Sequential()
layers = [input_dim, 100, 150, 200, 250, output_dim]
...
filepath_savemodel = 'C://Shaukat//code//rainfall//model_stored/orford//model_lstm_orford_v4.h5'
...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.01, patience=3, verbose=1, mode='auto', epsilon=0.0001, cooldown=0, min_lr=0.001)
