...
filepath_savemodel = 'C://Shaukat//code//rainfall//model_stored/orford//model_lstm_orford_v7.h5'
...
history = model.fit(x_train, y_train, nb_epoch=5000, verbose=1, validation_data=(x_test, y_test), batch_size = train_points, callbacks=[checkpointer, reduce_lr])
